...
int main(int argc, char **argv) 
{
  ...
  cb.cp().process({"Reducible"}).AddSyst(cb, "reducible_norm_mmem_stat_2018", "lnN", SystMap<>::init(1.03));
  ...
  TFile output((Input.ReturnToken(0)+"/"+"zh2018_mmem.input.root").c_str(), "RECREATE");
