...
int main() {
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"zh"}, {"2016"}, {"eeet"}, cats);

  vector<string> bkg_procs = {"Triboson","Reducible","ZZ"};//VV
  cb.AddProcesses({"*"}, {"zh"}, {"2016"}, {"eeet"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"zh"}, {"2016"}, {"eeet"}, sig_procs, cats, true);
  //! [part4]
...
*/
  ...
  TFile output("zh2016_eeet.input.root", "RECREATE");
