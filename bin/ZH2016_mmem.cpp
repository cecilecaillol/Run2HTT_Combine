...
int main() {
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"zh"}, {"2016"}, {"mmem"}, cats);

  vector<string> bkg_procs = {"Triboson","Reducible","ZZ"};//VV
  cb.AddProcesses({"*"}, {"zh"}, {"2016"}, {"mmem"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"zh"}, {"2016"}, {"mmem"}, sig_procs, cats, true);
  //! [part4]
...
*/
  ...
  TFile output("zh2016_mmem.input.root", "RECREATE");
