...
int main() {
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"zh"}, {"2016"}, {"eett"}, cats);

  vector<string> bkg_procs = {"Triboson","Reducible","ZZ"};//VV
  cb.AddProcesses({"*"}, {"zh"}, {"2016"}, {"eett"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"zh"}, {"2016"}, {"eett"}, sig_procs, cats, true);
  //! [part4]
...
*/
  ...
  TFile output("zh2016_eett.input.root", "RECREATE");
