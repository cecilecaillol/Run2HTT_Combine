...
int main(int argc, char **argv) 
{
  ...
  cb.cp().process({"Reducible"}).AddSyst(cb, "reducible_norm_mmmt_stat_2018", "lnN", SystMap<>::init(1.03));
  ...
  cb.cp().process(JoinStr({{"Triboson","ZZ","ZH_hww125"},sig_procs})).AddSyst(cb, "CMS_eff_m_2018", "lnN", SystMap<>::init(1.06));
  ...
  TFile output((Input.ReturnToken(0)+"/"+"zh2018_mmmt.input.root").c_str(), "RECREATE");
