...
int main() {
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"zh"}, {"2016"}, {"eeem"}, cats);

  vector<string> bkg_procs = {"Triboson","Reducible","ZZ"};//VV
  cb.AddProcesses({"*"}, {"zh"}, {"2016"}, {"eeem"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"zh"}, {"2016"}, {"eeem"}, sig_procs, cats, true);
  //! [part4]
  ...
  cb.cp().process({"Triboson","ZZ","ZH_lep_htt","ZH_lep_PTH_0_75","ZH_lep_PTV_75_150","ZH_lep_PTV_150_250_0J_htt","ZH_lep_PTV_150_250_GE1J_htt","ZH_lep_PTV_GT250_htt"}).AddSyst(cb, "CMS_singleeletrg_2016", "lnN", SystMap<>::init(1.02));
  cb.cp().process({"Triboson","ZZ","ZH_lep_htt","ZH_lep_PTH_0_75","ZH_lep_PTV_75_150","ZH_lep_PTV_150_250_0J_htt","ZH_lep_PTV_150_250_GE1J_htt","ZH_lep_PTV_GT250_htt"}).AddSyst(cb, "CMS_eff_e_2016", "lnN", SystMap<>::init(1.06));
  cb.cp().process({"Triboson","ZZ","ZH_lep_htt","ZH_lep_PTH_0_75","ZH_lep_PTV_75_150","ZH_lep_PTV_150_250_0J_htt","ZH_lep_PTV_150_250_GE1J_htt","ZH_lep_PTV_GT250_htt"}).AddSyst(cb, "CMS_eff_m_2016", "lnN", SystMap<>::init(1.02));
...
/*
  ...
  //Scale mu, ele
  cb.cp().process({"Triboson","ZZ","ZH_lep_htt","ZH_lep_PTH_0_75","ZH_lep_PTV_75_150","ZH_lep_PTV_150_250_0J_htt","ZH_lep_PTV_150_250_GE1J_htt","ZH_lep_PTV_GT250_htt"}).AddSyst(cb,"CMS_scale_e_2016", "shape", SystMap<>::init(1.00));
...
*/
  ...
  TFile output("zh2016_eeem.input.root", "RECREATE");
