  ...
  if(not Input.OptionExists("-s"))
      ...
      else if (Input.OptionExists("-dp") or Input.OptionExists("-dn") or Input.OptionExists("-dm")||Input.OptionExists("-dljpt")) 
	{
	  AddShapesIfNotEmpty({
		...
		//"CMS_FF_closure_mt_et_w_unc1_2018",
		//"CMS_FF_closure_mt_et_w_unc2_2018",
		"CMS_FF_closure_pth_et_w_2018",
		"CMS_FF_closure_norm_et_0jet_2018",
		"CMS_FF_closure_norm_et_1jet_2018",
		"CMS_FF_closure_norm_et_2jet_2018",
		"CMS_FF_closure_norm_et_3jet_2018",
		"CMS_FF_closure_norm_et_4jet_2018",
		},
	    {"jetFakes"},
	    &cb,
	    1.00,
