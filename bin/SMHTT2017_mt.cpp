  ...
  if(not Input.OptionExists("-s"))
      ...
      else if (Input.OptionExists("-dp") || Input.OptionExists("-dn") || Input.OptionExists("-dm")||Input.OptionExists("-dljpt"))
	{
	  AddShapesIfNotEmpty({
		...
		//"CMS_FF_closure_mt_mt_w_unc1_2017",
		//"CMS_FF_closure_mt_mt_w_unc2_2017",
		"CMS_FF_closure_pth_mt_w_2017",
		"CMS_FF_closure_norm_mt_0jet_2017",
		"CMS_FF_closure_norm_mt_1jet_2017",
		"CMS_FF_closure_norm_mt_2jet_2017",
		"CMS_FF_closure_norm_mt_3jet_2017",
		"CMS_FF_closure_norm_mt_4jet_2017",
		},
	    {"jetFakes"},
	    &cb,
	    1.00,
