...
int main() {
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"zh"}, {"2016"}, {"mmet"}, cats);

  vector<string> bkg_procs = {"Triboson","Reducible","ZZ"};//VV
  cb.AddProcesses({"*"}, {"zh"}, {"2016"}, {"mmet"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"zh"}, {"2016"}, {"mmet"}, sig_procs, cats, true);
  //! [part4]
  ...
  cb.cp().process({"Triboson","ZZ","ZH_lep_htt","ZH_lep_PTH_0_75","ZH_lep_PTV_75_150","ZH_lep_PTV_150_250_0J_htt","ZH_lep_PTV_150_250_GE1J_htt","ZH_lep_PTV_GT250_htt"}).AddSyst(cb, "CMS_eff_e_2016", "lnN", SystMap<>::init(1.02));
  cb.cp().process({"Triboson","ZZ","ZH_lep_htt","ZH_lep_PTH_0_75","ZH_lep_PTV_75_150","ZH_lep_PTV_150_250_0J_htt","ZH_lep_PTV_150_250_GE1J_htt","ZH_lep_PTV_GT250_htt"}).AddSyst(cb, "CMS_eff_m_2016", "lnN", SystMap<>::init(1.04));
...
*/
  ...
  TFile output("zh2016_mmet.input.root", "RECREATE");
