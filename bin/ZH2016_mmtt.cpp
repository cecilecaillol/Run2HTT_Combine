...
int main() {
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"zh"}, {"2016"}, {"mmtt"}, cats);

  vector<string> bkg_procs = {"Triboson","Reducible","ZZ"};//VV
  cb.AddProcesses({"*"}, {"zh"}, {"2016"}, {"mmtt"}, bkg_procs, cats, false);
  ...
  cb.AddProcesses(masses, {"zh"}, {"2016"}, {"mmtt"}, sig_procs, cats, true);
  //! [part4]
...
*/
  ...
  TFile output("zh2016_mmtt.input.root", "RECREATE");
